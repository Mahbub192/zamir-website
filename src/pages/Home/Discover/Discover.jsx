    ...
    return (
        <div className='container mx-auto  mt-20'>
            ...
            <div className='mt-36'>
                ...
                <div className='flex items-center justify-center bg-gray-100 p-5 mt-5'>
                    <div className='w-1/3'>
                    ...
                    <div className='w-2/3 pl-20 '>
                        <Link to={`https://www.youtube.com/watch?v=--tMDkLxSZ0&ab_channel=JamirKhan`}><img className='h-96 mx-auto' src={discover2} alt="" /></Link>
                    </div>
                </div>
                <div>
                    <p>More Videos</p>
